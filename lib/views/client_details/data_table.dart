...
class DataTableWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer3<ClientDetailsProvider, RoutesProvider, SingleProfileProvider>(
        builder: (context, ClientDetailsProvider clientDetailsProvider, RoutesProvider routesProvider, SingleProfileProvider singleProfileProvider, child) {
                ...
                return DataRow(
                  cells: [
                    ...
                    DataCell(IconButton(
                      ...
                      onPressed: () async {
                        // Handle button press
                        print('View Client pressed for ${clientDetail.formID}');
                        ...
                        ResponseModel responseModel = await Provider.of<ApiProvider>(context, listen: false).postRequest(
                          ...
                          body: {
                            "FormNo": encryptString("${clientDetail.formID}")
                          }
                        ).then((response) async {  
                          ...
                          if(response.statusCode != "0") {
                           ...
                           /// setting it in the `SingleProfileProvider` for further use.
                            ...
                            singleProfileProvider.setFormNo(clientDetail.formID.toString());
                          }
